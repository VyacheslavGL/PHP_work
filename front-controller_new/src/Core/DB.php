...
class DB
{
    ...
    private static $db; //в данном свойстве будем хранить обьект DB класса
    private $connection;
    ...
    public function getAll($sql, $class){
        ...
        //обьекты какого класса мы будем возращать
        $statement->setFetchMode(\PDO::FETCH_CLASS, $class); //$data = $statement->fetchAll(PDO::FETCH_ASSOC); - то же самое
